...
public class Frame00 extends javax.swing.JFrame {
    ...
    class imagePanel extends JPanel {
       ...
       try {
          ...
          image = ImageIO.read(new File("/home/amit/NetBeansProjects/miniproject/front.jpg"));
       } catch (Exception ex) {
            JLabel myLabel = new JLabel("ADVERTISEMENT");
            add(myLabel);
       }
    }
    ...
    public Frame00() {
        initComponents();
        NEW_ACC.setBackground(Color.BLACK);
        NEW_ACC1.setBackground(Color.BLACK);
    ...
    private void initComponents() {
        ...
        NEW_ACC.setForeground(new java.awt.Color(255, 255, 51));
        ...
        CLEAR1.setForeground(new java.awt.Color(255, 255, 51));
        CLEAR1.setText("BANK");
        ...
        NEW_ACC1.setForeground(new java.awt.Color(255, 255, 51));
    ...
    private void NEW_ACCActionPerformed(java.awt.event.ActionEvent evt) {                                        
    ...
    private void CLEAR1ActionPerformed(java.awt.event.ActionEvent evt) {                                       
        // TODO add your handling code here:
        new Frame07(this.userid).setVisible(true);
        this.dispose();
    }                                      

    private void NEW_ACC1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        // TODO add your handling code here:
